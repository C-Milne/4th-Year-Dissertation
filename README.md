...
6. -heuModName TreeDistancePartialOrder -heuPath Solver/Heuristics/tree_distance_partial_order.py
7. -heuModName TreeDistance -heuPath Solver/Heuristics/tree_distance.py